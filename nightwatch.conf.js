//require('.env'); // optionally store your environment variables in .env
	...
	"test_settings": {
		"default": {
    		"launch_url": "http://localhost", // we're testing a Public or "staging" site on Saucelabs
      		...
      		"username" : "",     // if you want to use Saucelabs remember to
      		"access_key" : "", // export your environment variables (see readme)
      		"globals": {
